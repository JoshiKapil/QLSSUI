...
export const CERTIFICATE_PDF_LAYOUT = {
    ...
    background: { x: 0, y: 0, fit: 'fill', cropPageToArtwork: false },
    colors: {
    ...
    details: {
        certificateNumber: { label: 'CERTIFICATE NO.', centerX: 193.25, maxWidth: 137, fontSize: 10.4, minimumFontSize: 8.2, maxLines: 2, lineHeight: 10, weight: 'bold' },
        trainingHours: { label: 'TRAINING HOURS', centerX: 355.75, maxWidth: 137, fontSize: 10.4, minimumFontSize: 8.2, maxLines: 1, lineHeight: 10, weight: 'bold' },
        location: { label: 'LOCATION', centerX: 518.25, maxWidth: 137, fontSize: 10.4, minimumFontSize: 8.2, maxLines: 2, lineHeight: 10, weight: 'bold' },
        trainerName: { label: 'TRAINER NAME', centerX: 680.75, maxWidth: 137, fontSize: 10.4, minimumFontSize: 8.2, maxLines: 2, lineHeight: 10, weight: 'bold' }
    },
    dateOfIssue: { centerX: 220, fontSize: 9.4, minimumFontSize: 8, maxWidth: 93, maxLines: 1, lineHeight: 9, weight: 'regular' },
    fileName: { fallback: 'training-certificate', maxSlugLength: 60 }
};
//# sourceMappingURL=certificate-pdf-layout.config.js.map