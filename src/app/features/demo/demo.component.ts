...
export class DemoComponent implements OnInit {
  ...
  menuGroups = [
    ...
    },
    {
      ...
      items: [{ label: 'KPI Entry', icon: 'bi bi-bar-chart-line' }],
    },
    {
  ...
  trainings: DemoTraining[] = [
    {
      ...
      TrainingName: 'IATF 16949 Internal Auditor Training',
      Duration: '2 Days',
      Modules: 8,
      TrainingDesc: 'Understand the requirements and prepare for internal audits as per IATF 16949:2016 standard.',
    ...
    },
    {
      id: 2,
      CategoryId: 2,
      CategoryName: 'Core Tools',
      TrainingName: 'Core Tools Training for Automotive Quality',
      Duration: '2 Days',
      Modules: 7,
      TrainingDesc: 'Learn the essential 7 core tools used in quality planning and continuous improvement.',
      icon: 'fa-briefcase',
      theme: 'green',
    },
    {
      id: 3,
      CategoryId: 1,
      CategoryName: 'Quality Tools',
      TrainingName: '7 QC Tools Training 2 Days',
      Duration: '2 Days',
      Modules: 6,
      TrainingDesc:
        'Understand and apply the 7 basic quality control tools to analyze and solve real-time quality problems.',
    ...
    },
    {
      ...
      TrainingName: 'Problem Solving & Root Cause Analysis',
      Duration: '2 Days',
      Modules: 6,
      TrainingDesc:
        'Build strong problem-solving skills using proven methodologies like RCA, 5 Why, Fishbone Diagram and more.',
      icon: 'fa-users',
      theme: 'orange',
    },
    {
      ...
      CategoryId: 1,
      CategoryName: 'Quality Tools',
      TrainingName: 'Statistical Process Control (SPC)',
      Duration: '2 Days',
      Modules: 7,
      TrainingDesc: 'Learn SPC techniques to monitor process variation and improve product quality.',
      icon: 'fa-gear',
      theme: 'cyan',
    },
    {
      id: 6,
      CategoryId: 3,
      CategoryName: 'Measurement System',
      TrainingName: 'Measurement System Analysis (MSA)',
      Duration: '2 Days',
      Modules: 6,
      TrainingDesc: 'Understand measurement system evaluation techniques to ensure data accuracy and reliability.',
      icon: 'fa-award',
      theme: 'pink',
    },
  ];
