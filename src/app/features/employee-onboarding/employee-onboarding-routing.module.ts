...
const routes: Routes = [
  ...
  {
    path: '', component: OnboardingShellComponent, canActivate: [AuthGuard], children: [
      ...
      { path: 'access-requests', component: OnboardingAccessRequestsComponent, canActivate: [OnboardingSuperAdminGuard] },
