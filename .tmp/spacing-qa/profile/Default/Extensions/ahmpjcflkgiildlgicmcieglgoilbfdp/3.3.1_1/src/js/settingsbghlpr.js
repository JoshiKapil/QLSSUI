...
FdmSettingsPageHelper.prototype.setIcon = function(in_pause)
{
    ...
    if (in_pause) {
        action.setIcon({
          path: {
            16: "/assets/images/fdm16_pause.png",
            32: "/assets/images/fdm32_pause.png",
            48: "/assets/images/fdm48_pause.png",
            64: "/assets/images/fdm64_pause.png",
            96: "/assets/images/fdm96_pause.png",
            128: "/assets/images/fdm128_pause.png"
          }
        })
    } else {
        action.setIcon({
          path: {
            16: "/assets/images/fdm16.png",
            32: "/assets/images/fdm32.png",
            48: "/assets/images/fdm48.png",
            64: "/assets/images/fdm64.png",
            96: "/assets/images/fdm96.png",
            128: "/assets/images/fdm128.png"
          }
        })
    }
};
